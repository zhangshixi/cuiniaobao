...
export const asyncRouterMap = [
  {
    ...
    children: [
      { path: 'company', component: _import('basics/company'), name: 'company', meta: { title: 'company', noCache: true }},
      { path: 'platform', component: _import('basics/platform'), name: 'platform', meta: { title: 'platform', noCache: true }},
      { path: 'product/type', component: _import('charts/mixChart'), name: 'productType', meta: { title: 'productType', noCache: true }},
      { path: 'product', component: _import('charts/mixChart'), name: 'product', meta: { title: 'product', noCache: true }}
    ]
  },
